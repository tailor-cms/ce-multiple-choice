...
End-user component for the **Multiple Choice** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-multiple-choice-display
```
...
```ts
import { Display } from '@tailor-cms/ce-multiple-choice-display';
```
